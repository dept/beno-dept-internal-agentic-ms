...
- **AI Project Discovery Agent** (`agents/ai-project-discovery-agent.agent.md`): generates the complete `.ai` folder for a new or previously undocumented project.
- **AI Project Maintainer Agent** (`agents/ai-project-maintainer-agent.agent.md`): keeps `.ai` files current as the project evolves. Run after each sprint, release, infrastructure change, or incident postmortem.
